...
public class ShowingController {
    ...
    public String create(@ModelAttribute Showing showing, BindingResult bindingResult) {
    ...
    public String delete(@PathVariable Integer id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addAttribute("operationResultMessage", "Showing has been deleted");
